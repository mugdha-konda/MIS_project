...
using Group7_FinalProject.Utilities;
using System;
...
namespace Group7_FinalProject.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel rvm)
        {
            ...
            if (rvm.Email == null || rvm.Password == null)
            {
                Console.WriteLine(rvm.FirstName);
                Console.WriteLine(rvm.LastName);
                Console.WriteLine(rvm.Email);
                Console.WriteLine(rvm.Password);
                Console.WriteLine(rvm.ConfirmPassword);

                return View(rvm);
            }

            Console.WriteLine("I successed <------");
            ...
            IdentityResult result = await Group7_FinalProject.Utilities.AddUser.AddUserWithRoleAsync(aum, _userManager, _context);
